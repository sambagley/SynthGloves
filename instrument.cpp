...
void Instrument::setKey(int k)
{
 ...
 switch (k){
   case -12 :
    rootFrequency = 220.0/2.0;
    break;
   case -11 :
    rootFrequency = 233.08/2.0;
    break;
   case -10 :
    rootFrequency = 246.94/2.0;
    break;
   case -9 :
    rootFrequency = 261.63/2.0;
    break;
   case -8 :
    rootFrequency = 277.18/2.0;
    break;
   case -7 :
    rootFrequency = 293.66/2.0;
    break;
   case -6 :
    rootFrequency = 311.13/2.0;
    break;
   case -5 :
    rootFrequency = 329.63/2.0;
    break;
   case -4 :
    rootFrequency = 349.23/2.0;
    break;
   case -3 :
    rootFrequency = 369.99/2.0;
    break;
   case -2 :
      rootFrequency = 392.00/2.0;
    break;
   case -1 :
   ...
   case 1 :
    ...
    break;
   case 2 :
    rootFrequency = 493.88/2.0;
    break;
   case 3 :
    rootFrequency = 523.25/2.0;
    break;
   case 4 :
    rootFrequency = 554.37;
    break;
   case 5 :
    rootFrequency = 587.33/2.0;
    break;
   case 6 :
   rootFrequency = 622.25/2.0;
    break;
   case 7 :
    rootFrequency = 659.25/2.0;
    break;
   case 8 :
    rootFrequency = 698.46/2.0;
    break;
   case 9 :
    rootFrequency = 739.99/2.0;
    break;
   case 10 :
   rootFrequency = 783.99/2.0;
    break;
   case 11 :
    rootFrequency = 830.61/2.0;
    break;
   case 12 :
    rootFrequency = 880.0/2.0;
    break;
   default:
